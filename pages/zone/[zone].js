...
import SearchInputForm from "@/components/Zone/SearchInputForm";
import SelectedSubsDiv from "@/components/Zone/SelectedSubsDiv";
import {
  SubjectMap,
  SubjectReverseMap,
  SubjectTextMap,
    ...
    <>
      ...
      {allowChangingType && (
        <div className="flex w-full flex-row justify-between items-center p-4">
          <button
            className="z-50 bg-dark text-4xl sm:text-6xl text-white transition-all duration-300 hover:text-primary"
      ...
      <SelectedSubsDiv defaultVisiblity={"hidden"} responsiveVisiblity={""} selectedSubs={selectedSubs} setFilteredSubject={setFilteredSubject} setSelectedSubs={setSelectedSubs} openEditModal={openEditModal}/>

      

      {/** Absolute Positioned Main Div containing Search Engine Front End*/}
      <SearchInputForm showModal={showModal} openModal={openModal} subjectType={subjectType} addSubject={addSubject} selectedSubject={selectedSubjects} setFilteredSubject={setFilteredSubject} filteredData={filteredData} searchInput={searchInput} setSearchInput={setSearchInput} searchInputRef={searchInputRef} setFilteredData={setFilteredData} selectedSubs={selectedSubs} />
      

      <SelectedSubsDiv defaultVisiblity={""} responsiveVisiblity={"hidden"} selectedSubs={selectedSubs} setFilteredSubject={setFilteredSubject} setSelectedSubs={setSelectedSubs} openEditModal={openEditModal}/>
